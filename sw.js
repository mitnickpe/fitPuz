...
class $ {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: c, matchOptions: i } = this._strategy, o = await self.caches.open(c), h = this.hasCallback("cacheDidUpdate"), g = h ? await O(
...
class V {
  ...
  addToCacheList(e) {
    ...
    for (const s of e) {
      ...
      const { cacheKey: n, url: r } = F(s), c = typeof s != "string" && s.revision ? "reload" : "default";
...
ne();
ce([{"revision":null,"url":"assets/github-bb39f6ee.svg"},{"revision":null,"url":"assets/index-12564afe.css"},{"revision":null,"url":"assets/index-b926d2b2.js"},{"revision":null,"url":"assets/solved-698d9f57.mp3"},{"revision":"7af61a01c24e6944e9ea6f22934129df","url":"favicon.png"},{"revision":"f6bae04ef6855bfb7bd237c4b63fe977","url":"index.html"},{"revision":"73d3ebdb115ad0d3667c95a7b020cb26","url":"Righteous.woff2"},{"revision":"4bb3f3ed97774006e1d77e2f7da44680","url":"site.webmanifest"}]);
self.skipWaiting();
S();
